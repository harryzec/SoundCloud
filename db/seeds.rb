...
miguelcov = open('https://notecloud-seeds.s3.amazonaws.com/miguelcov.jpg')
Miguel.cover_photo.attach({io: miguelcov, filename: 'miguelcov.jpg'})
...
adorepic = open('https://notecloud-seeds.s3.amazonaws.com/adorepic.jpg')
Adore.photo.attach({io: adorepic, filename: 'adorepic.jpg'})

Juice = Song.create(title: "Juice", user_id: Lizzo.id, genre: 'Pop', hyperlink: 'juicey', plays: 600)
juicesong = open('https://notecloud-seeds.s3.amazonaws.com/03+Juice.m4a')
Juice.track.attach({io: juicesong, filename: '03 Juice.m4a'})
juicepic = open('https://notecloud-seeds.s3.amazonaws.com/juicepic.jpg')
Juice.photo.attach({io: juicepic, filename: 'juicepic.jpg'})

Lover = Song.create(title: "Lover", user_id: Taylor.id, genre: 'Pop', hyperlink: 'lover', plays: 700)
loversong = open('https://notecloud-seeds.s3.amazonaws.com/03+Lover.m4a')
Lover.track.attach({io: loversong, filename: '03 Lover.m4a'})
loverpic = open('https://notecloud-seeds.s3.amazonaws.com/loverpic.jpeg')
Lover.photo.attach({io: loverpic, filename: 'loverpic.jpeg'})

NASA = Song.create(title: "NASA", user_id: Ariana.id, genre: 'YES', hyperlink: 'nasa', plays: 320)
nasasong = open('https://notecloud-seeds.s3.amazonaws.com/03+NASA.m4a')
NASA.track.attach({io: nasasong, filename: '03 NASA.m4a'})
nasapic = open('https://notecloud-seeds.s3.amazonaws.com/nasapic.jpeg')
NASA.photo.attach({io: nasapic, filename: 'nasapic.jpeg'})

SICKO = Song.create(title: "Sicko Mode", user_id: Travis.id, genre: 'LEGENDS', hyperlink: 'sickomode', plays: 1000)
sickosong = open('https://notecloud-seeds.s3.amazonaws.com/03+SICKO+MODE.m4a')
SICKO.track.attach({io: sickosong, filename: '03 SICKO MODE.m4a'})
sickopic = open('https://notecloud-seeds.s3.amazonaws.com/sickopic.jpg')
SICKO.photo.attach({io: sickopic, filename: 'sickopic.jpg'})

Skywalker = Song.create(title: "Skywalker", user_id: Miguel.id, genre: 'skywalker', hyperlink: 'skywalker', plays: 271)
skytrack = open('https://notecloud-seeds.s3.amazonaws.com/03+Sky+Walker+(feat.+Travis+Scott).m4a')
Skywalker.track.attach({io: skytrack, filename: '03 Sky Walker (feat. Travis Scott).m4a'})
skypic = open('https://notecloud-seeds.s3.amazonaws.com/skypic.jpg')
Skywalker.photo.attach({io: skypic, filename: 'skypic.jpg'})

Venice = Song.create(title: "Venice Bitch", user_id: Lana.id, genre: 'Good Music', hyperlink: 'veniceb', plays: 348)
venictrack = open('https://notecloud-seeds.s3.amazonaws.com/03+Venice+Bitch.m4a')
Venice.track.attach({io: venictrack, filename: '03 Venice Bitch.m4a'})
venicepic = open('https://notecloud-seeds.s3.amazonaws.com/venicepic.jpg')
Venice.photo.attach({io: venicepic, filename: 'venicepic.jpg'})

Boulevard = Song.create(title: "Boulevard of Broken Dreams", user_id: Green.id, genre: 'Broken', hyperlink: 'BBD', plays: 706)
boulevardtrack = open('https://notecloud-seeds.s3.amazonaws.com/04+Boulevard+of+Broken+Dreams.m4a')
Boulevard.track.attach({io: boulevardtrack, filename: '04 Boulevard of Broken Dreams.m4a'})
boulpic = open('https://notecloud-seeds.s3.amazonaws.com/boulpic.jpeg')
Boulevard.photo.attach({io: boulpic, filename: 'boulpic.jpeg'})

Plastic = Song.create(title: "Fake Plastic Trees", user_id: Radiohead.id, genre: 'Depressed', hyperlink: 'FakePlastic', plays: 159)
plastictrack = open('https://notecloud-seeds.s3.amazonaws.com/04+Fake+Plastic+Trees.m4a')
Plastic.track.attach({io: plastictrack, filename: '04 Fake Plastic Trees.m4a'})
plasticpic = open('https://notecloud-seeds.s3.amazonaws.com/plasticpic.jpg')
Plastic.photo.attach({io: plasticpic, filename: 'plasticpic.jpg'})

Physical = Song.create(title: "Physical", user_id: DUAL.id, genre: 'Work Out', hyperlink: 'physical', plays: 392)
physicalt = open('https://notecloud-seeds.s3.amazonaws.com/04+Physical.m4a')
Physical.track.attach({io: physicalt, filename: '04 Physical.m4a'})
physicalpic = open('https://notecloud-seeds.s3.amazonaws.com/physicalpic.jpg')
Physical.photo.attach({io: physicalpic, filename: 'physicalpic.jpg'})

Mansong = Song.create(title: "The Man", user_id: Taylor.id, genre: 'Pop', hyperlink: 'the_man', plays: 500)
mantrack = open('https://notecloud-seeds.s3.amazonaws.com/04+The+Man.m4a')
Mansong.track.attach({io: mantrack, filename: '04 The Man.m4a'})
manpic = open('https://notecloud-seeds.s3.amazonaws.com/theman.jpg')
Mansong.photo.attach({io: manpic, filename: 'theman.jpg'})
...
play17 = Playlist.create(user_id: Zeppelin.id, title: "Work From Home Chill", permalink: "workfromhone")
play17pic = open('https://notecloud-seeds.s3.amazonaws.com/fromhomepic.jpg')
play17.photo.attach({io: play17pic, filename: 'fromhomepic.jpg'})
