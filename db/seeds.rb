...
humble = Song.create(title: 'HUMBLE', user_id: demouser.id, genre: 'rap', hyperlink: 'HUMBLE')
...
Nikes = Song.create(title: "Nikes", user_id: demouser.id, genre: 'SadBoy', hyperlink: 'Nikes')
...
play5 = Playlist.create(user_id: demouser.id, title: "Drum & Bass")
...
play6 = Playlist.create(user_id: demouser.id, title: "Classical")
...
play10 = Playlist.create(user_id: demouser.id, title: "Trending")
...
play16 = Playlist.create(user_id: demouser.id, title: "R&B Workout")
